...
const NewStudentIdCardIntentHandler = {
    ...
    handle(handlerInput){
        ...
        const speechOutput = speechOutJson[0].newStudentIdCard + randomizeFunction(questionPossibility);
...
module.exports = NewStudentIdCardIntentHandler;