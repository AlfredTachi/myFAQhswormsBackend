...
const SemesterReregistrationIntentHandler = {
    canHandle(handlerInput){
        const res = handlerInput.requestEnvelope.request;

        return res.type === 'IntentRequest' &&
                res.intent.name === 'SemesterReregistrationIntent';
    },
    handle(handlerInput){
        ...
        const speechOutput = speechOutJson[0].semesterReregistration + randomizeFunction(questionPossibility);
...
module.exports = SemesterReregistrationIntentHandler;