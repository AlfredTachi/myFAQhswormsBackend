...
const EquivalenceOfStudentIdIntentHandler = {
    canHandle(handlerInput){
        const res = handlerInput.requestEnvelope.request;

        return res.type === 'IntentRequest' &&
                res.intent.name === 'EquivalenceOfStudentIdIntent';
    },
    handle(handlerInput){
        ...
        const speechOutput = speechOutJson[0].equivalenceOfStudentId + randomizeFunction(questionPossibility);
...
module.exports = EquivalenceOfStudentIdIntentHandler;