...
const ExamforWinterToSommerIntentHandler = {
    canHandle(handlerInput){
        const res = handlerInput.requestEnvelope.request;

        return res.type === 'IntentRequest' &&
                res.intent.name === 'ExamforWinterToSommerIntent';
    },
    handle(handlerInput){
        ...
        const speechOutput = speechOutJson[0].examforWinterToSommer + randomizeFunction(questionPossibility);
...
module.exports = ExamforWinterToSommerIntentHandler ;