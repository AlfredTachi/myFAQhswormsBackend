...
const ExamReviewsIntentHandler = {
    ...
    handle(handlerInput){
        ...
        const speechOutput = speechOutJson[0].examReviews + randomizeFunction(questionPossibility);
...
module.exports = ExamReviewsIntentHandler;