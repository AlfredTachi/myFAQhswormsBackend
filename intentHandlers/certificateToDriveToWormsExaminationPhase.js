...
const CertificateToDriveToWormsExaminationPhaseIntentHandler = {
    canHandle(handlerInput){
        const res = handlerInput.requestEnvelope.request;

        return res.type === 'IntentRequest' &&
                res.intent.name === 'CertificateToDriveToWormsExaminationPhaseIntent';
    },
    handle(handlerInput){
        ...
        const speechOutput = speechOutJson[0].certificateToDriveToWormsExaminationPhase + randomizeFunction(questionPossibility);
...
module.exports = CertificateToDriveToWormsExaminationPhaseIntentHandler;