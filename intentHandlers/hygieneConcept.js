...
const HygieneConceptIntentHandler = {
    ...
    handle(handlerInput){
        ...
        const speechOutput = speechOutJson[0].hygieneConcept + randomizeFunction(questionPossibility);
...
module.exports = HygieneConceptIntentHandler;