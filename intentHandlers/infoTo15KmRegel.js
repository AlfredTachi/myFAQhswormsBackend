...
const InfoToFuenfZehnKmRegelIntentHandler = {
    canHandle(handlerInput){
        const res = handlerInput.requestEnvelope.request;

        return res.type === 'IntentRequest' &&
                res.intent.name === 'InfoToFuenfZehnKmRegelIntent';
    },
    handle(handlerInput){
        ...
        const speechOutput = speechOutJson[0].infoTo15KmRegel + randomizeFunction(questionPossibility);
...
module.exports = InfoToFuenfZehnKmRegelIntentHandler;